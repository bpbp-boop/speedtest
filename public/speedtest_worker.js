...
var clientIp = ""; // client's IP address as reported by get_ip.php
...
var settings = {
	...
	url_getIp: "backend/get_ip.php", // path to get_ip.php relative to this js file, or a similar thing that outputs the client's ip
